...
public class text_editor {
    ...
    public void initalize() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (!bulyazi.getText().isEmpty()) {
                    ...
                    if (n != -1) {
                        ...
                        label.setText("Aratildi");
                    } else {
                        JOptionPane.showMessageDialog(frmTextEditor, "Aratilan deger bulunamadi");
                    }
                } else {
                    JOptionPane.showMessageDialog(frmTextEditor, "Lutfen deger giriniz!");
                }
            }
        });
        ...
        repbilgi.setText("Bul ve Degistir|\n Yeni metni yazin");
        mnbul.add(repbilgi);
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (!bulyazi.getText().isEmpty()) {
                    ...
                    if (n != -1) {
                        ...
                        label.setText("Degistirildi");
                    } else {
                        JOptionPane.showMessageDialog(frmTextEditor, "Aratilan deger bulunamadi");
                    }
                } else {
                    JOptionPane.showMessageDialog(frmTextEditor, "Lutfen degistirilcek degeri giriniz!");
                }
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (kayitli) {
                    ...
                    int uyari = JOptionPane.showConfirmDialog(frmTextEditor,
                            "Dikkat! Dosyayi kaydetmeden yeni dosya olusturuyorsun emin misin?", "Uyari!",
                ...
                if (kayitli) {
                    ...
                    if (temp == JFileChooser.APPROVE_OPTION) {
                        ...
                        try {
                            ...
                            label.setText("Dosya Acildi " + acilandosya);
                            frmTextEditor.setTitle("Editor " + surum + " - " + file.getName());
                        } catch (Exception ex) {
                            JOptionPane.showMessageDialog(frmTextEditor, ex.getMessage());
