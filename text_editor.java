        ...
        bulyazi.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                if (!bulyazi.getText().isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(frmTextEditor, "Lütfen deger giriniz!");
                }
            }
        });
        ...
        repyazi.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                if (!bulyazi.getText().isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(frmTextEditor, "Lütfen degistirilcek degeri giriniz!");
                }
